...
export const ORDER_DETAIS_REQUEST = 'ORDER_DETAIS_REQUEST';
export const ORDER_DETAIS_SUCCESS = 'ORDER_DETAIS_SUCCESS';
export const ORDER_DETAIS_FAIL = 'ORDER_DETAIS_FAIL';
